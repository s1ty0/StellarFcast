...
class TokenEmbedding(nn.Module):
    ...
    def forward(self, x):
        x = self.tokenConv(x.permute(0, 2, 1)).transpose(1, 2)  # (32, 96, 8) -> (32, 8, 96) -> (self.tokenConv) ->(32, 512, 96) -> (32, 96, 512)
        return x
...
class PatchEmbedding(nn.Module):
    ...
    def forward(self, x):
        # print("PatchEmbedding input shape:", x.shape)  # 应该是 [B, D, 512] 形状不对，调试此行代码
        n_vars = x.shape[1]
